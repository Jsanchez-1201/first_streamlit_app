...
with open('C:/Users/adria/Desktop/streamlit/standard_columns.yml', 'r') as default_yaml:
    default_reference_columns = yaml.safe_load(default_yaml)

# added a way to upload both excel and csv files
...
if st.button("Next Page"):
    ...
    updated_dataframe = prueba.page_1()
